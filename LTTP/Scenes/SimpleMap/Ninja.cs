...
namespace LTTP.Scenes.SimpleMap
{
    public class Ninja : Component, ITriggerListener, IUpdatable
    {
        ...
        public override void OnAddedToEntity()
        {
            ...
            var texture = Entity.Scene.Content.Load<Texture2D>("characters/ninja");
        ...
        void IUpdatable.Update()
        {
            ...
            if (_fireInput.IsPressed)
            {
                ...
                //var ninjaScene = Entity.Scene as SimpleMapScene;
        ...
        #endregion ITriggerListener implementation
    }
}